<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="员工邮箱" prop="yuangongyouxiang">
          <el-input v-model="ruleForm.yuangongyouxiang" 
              placeholder="员工邮箱" clearable  :readonly="ro.yuangongyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="员工邮箱" prop="yuangongyouxiang">
              <el-input v-model="ruleForm.yuangongyouxiang" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='yuangongyouxiang'){
            this.ruleForm.yuangongyouxiang = obj[o];
	    this.ro.yuangongyouxiang = true;
            continue;
          }
        }
      }
